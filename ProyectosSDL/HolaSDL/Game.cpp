...
void Game::loadMap() {
	...
	if (file.is_open()) {
		...
		/*
		//ver como hacer esto en principio meter la primera linea y el for en una funcion y pasarle numrow y numcols como argumento
		mapCell = new MapCell *[map->getNumRows()];
