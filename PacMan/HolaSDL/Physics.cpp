...
bool Physics::SDL_TransparentPixel(SDL_Surface * surface, int u, int v)
{
	...
	uint keycolor;
	SDL_GetColorKey(surface, &keycolor);
	return (pixelcolor == keycolor);
}

int Physics::SDL_Collide(SDL_Surface * as, int ax, int ay, SDL_Surface * bs, int bx, int by)
...
int Physics::SDL_BoundingCollide(SDL_Surface * sa, int ax, int ay, SDL_Surface * sb, int bx, int by)
{
...
int Physics::SDL_BoudingCollide(Rect* a, Rect* b)
{
